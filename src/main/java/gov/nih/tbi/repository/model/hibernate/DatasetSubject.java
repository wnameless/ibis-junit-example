...
import gov.nih.tbi.commons.model.hibernate.SecureSubject;
...
public class DatasetSubject implements Serializable, GuidJoinedData {
  ...
  @GeneratedValue(strategy = GenerationType.SEQUENCE,
      generator = "DATASET_SUBJECT_SEQ")
  @SequenceGenerator(name = "DATASET_SUBJECT_SEQ",
      sequenceName = "DATASET_SUBJECT_SEQ", allocationSize = 1)
  private Long id;
