...
/**
 * This is the data model for conditions used for conditional logic in map
 * elements
 * 
 * @author Francis Chen
 */
...
public class Condition implements Serializable {
  ...
  public boolean evaluate(String value) {
    ...
    if (DataType.ALPHANUMERIC.equals(mapElement.getType())
        || DataType.GUID.equals(mapElement.getType())) {
      switch (operator) {
      case EQ:
    ...
    } else if (DataType.NUMERIC.equals(mapElement.getType())) {
    ...
    } else if (DataType.DATE.equals(mapElement.getType())) {
      try {
    ...
    } else if (DataType.FILE.equals(mapElement.getType())
        || DataType.THUMBNAIL.equals(mapElement.getType())) {
    ...
    } else if (DataType.BIOSAMPLE.equals(mapElement.getType())) {
      /*
