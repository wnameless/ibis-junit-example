...
public class PostgreConstants {
  ...
  public static final String[] SYSTEM_COLUMNS = new String[] { "oid",
      "tableoid", "xmin", "cmin", "xmax", "cmax", "ctid" };
  public static final String CREATE_CHARACTER_VARYING =
      "character varying(%1$d)";
  ...
  public static final String CREATE_FILE = "character varying(100)";
  public static final String CREATE_THUMBNAIL = "character varying(100)";
