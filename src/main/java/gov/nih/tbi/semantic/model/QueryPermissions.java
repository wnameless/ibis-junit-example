...
/**
 * 
 * NOTE THIS CLASS IS MIRRORED IN THE QUERY TOOL (pojo package). ANY CHANGES
 * WILL NEED TO BE COPIED THERE AS WELL
 * 
 * THIS WAS TO PREVENT DEPENDENCIES BETWEEN THE TWO (AT SOME POINT JUST NEED TO
 * ADD THE DEPENDENCY)
 */
...
public class QueryPermissions {
  ...
  private List<StudyResultPermission> studyResultPermissions =
      new ArrayList<StudyResultPermission>();
  private List<FormResultPermission> formResultPermissions =
      new ArrayList<FormResultPermission>();
  ...
  public StudyResultPermission getStudyResultPermissionByStudyURI(
      String studyURI) {
  ...
  public FormResultPermission getFormResultPermissionByFormId(Long formId) {
    ...
    for (FormResultPermission formResultPermission : formResultPermissions) {
      if (formResultPermission.getFormId() != null
          && formId.equals(formResultPermission.getFormId())) {
  ...
  public void setStudyResultPermissions(
      List<StudyResultPermission> studyResultPermissions) {
  ...
  public void setFormResultPermissions(
      List<FormResultPermission> formResultPermissions) {
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  public static class StudyResultPermission {
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  public static class FormResultPermission {
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  public static class StudyDataset {
