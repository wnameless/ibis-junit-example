...
public class StudyRDF {
  ...
  public static final Property PROPERTY_DATA_MANAGER_EMAIL =
      property("dataManagerEmail");
  ...
  public static final Property PROPERTY_PI_EMAIL =
      property("principalInvestigatorEmail");
  public static final Property PROPERTY_TITLE = property("title");
  public static final Property PROPERTY_GRANT = property("grant");
  public static final Property PROPERTY_CLINICAL_TRIAL =
      property("clinicalTrial");
  public static final Property PROPERTY_STATUS = property("status");

  // Relationship Properties
  public static final Property RELATION_PROPERTY_HAS_DATA_FORM =
      property("hasDataForm");

  // Exhibit Relationship
  public static final Property RELATION_PROPERTY_FACETED_STUDY =
      property("facetedStudy");
  public static final Property RELATION_PROPERTY_FACETED_FORM =
      property("facetedForm");
  public static final Property RELATION_PROPERTY_FACETED_DE =
      property("facetedDE");
  public static final Property RELATION_PROPERTY_FACETED_DATASET =
      property("facetedDataset");
  ...
  public static String generateName(AbstractStudy study) {

    return study.getTitle();
  }

  // Should be moved to Study Domain
  public static Resource createStudyResource(AbstractStudy study) {
