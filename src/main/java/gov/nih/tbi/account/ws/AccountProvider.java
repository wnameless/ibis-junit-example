...
/**
 * Provides a lightweight implemenation of the client side classes needed to
 * utilize a JaxWS Service.
 * 
...
public class AccountProvider extends AuthenticationProvider {
  ...
  private static final String wsdlExtension =
      "portal/ws/accountWebService?wsdl";
   ...
   */
  public AccountProvider(String serverLocation, String userName, String password)
      throws MalformedURLException {

    super(serverLocation, userName, password);
    WSDL_LOCATION =
        new URL(AccountProvider.class.getResource("."), serverLocation
            + wsdlExtension);
  ...
  public Account getAccountById(Long id) {
    ...
    Account account =
        accountWebService.getAccountDetailsById(getUserLogin(), id);
    return account;
  }
  ...
  public EntityMap getAccess(Long accountId, EntityType entityType,
    ...
    return accountWebService.getAccess(getUserLogin(), accountId, entityType,
        entityId, includePermissionGroups);
  }
  ...
  public Account getEntityOwnerAccount(Long entityId, EntityType type) {
    ...
    return accountWebService.getEntityOwnerAccount(getUserLogin(), entityId,
        type);
  }
  ...
  public void registerEntity(Long accountId, EntityType type, Long entityId,
    ...
    accountWebService.registerEntity(getUserLogin(), accountId, type, entityId,
  ...
  public Set<Long> listUserAccess(Long accountId, EntityType type,
    ...
    return accountWebService.listUserAccess(getUserLogin(), accountId, type,
        permission, onlyGranted);
  }
