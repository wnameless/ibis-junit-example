...
public class EntityMap extends AbstractBricsObject implements Serializable {
  ...
  @GeneratedValue(strategy = GenerationType.SEQUENCE,
      generator = "ENTITY_MAP_SEQ")
  @SequenceGenerator(name = "ENTITY_MAP_SEQ", sequenceName = "ENTITY_MAP_SEQ",
      allocationSize = 1)
  private Long id;
  ...
  public Long getDiseaseKey() {
    ...
    if (account != null && account.getDiseaseKey() != null) {
      diseaseKey = Long.valueOf(account.getDiseaseKey());
        ...
        && permissionGroup.getDiseaseKey() != null) {
  ...
  public String toString() {
    ...
    return "EntityMap [entityId=" + entityId + ", id=" + id + ", permission="
        + permission + ", typeId=" + type + account == null ? (", accountId="
        + account.toString() + "]") : "";
  }
