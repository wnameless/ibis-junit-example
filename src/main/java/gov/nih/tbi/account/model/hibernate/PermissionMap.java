...
public class PermissionMap extends AbstractBricsObject implements Serializable {
  ...
  @GeneratedValue(strategy = GenerationType.SEQUENCE,
      generator = "PERMISSION_MAP_SEQ")
  @SequenceGenerator(name = "PERMISSION_MAP_SEQ",
      sequenceName = "PERMISSION_MAP_SEQ", allocationSize = 1)
  private Long id;
